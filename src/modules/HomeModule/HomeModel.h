...
class HomeModel : public QObject {
  ...
  public:
    ...
    Q_INVOKABLE QVector<news_item> newsItems() const { return m_newsItems; }

    Q_INVOKABLE QVector<on_this_day_event> onThisDayEvents() const { return m_onThisDayEvents; }

    Q_INVOKABLE QVector<did_you_know_item> didYouKnowItems() const { return m_didYouKnowItems; }
